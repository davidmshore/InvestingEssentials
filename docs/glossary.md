...
### Fiduciary
- Fiduciaries are legally bound to put their client’s best interests ahead of their own. This should be 100% of the time for professional advisors. It can be less than this if a professional is not bound by a code of ethics based on their advisor certification.
...
## Tax Definitions
### Effective Tax Rate
- The average tax rate paid on all income to a taxing authority. The number is unique to each individual and is equal to **total tax / taxable income * 100%**. You can find your total tax on line 24 of Form 1040 of your tax return and your taxable income on line 15.
### Marginal Tax Rate
...
- Although somewhat counterintuitive, selling for a loss and repurchasing at the same price (or about the same price) and subsequently investing the resulting tax savings results in more investment income and a higher return later on.
