...
### Expense Ratio
- The calculation of a fund's total management cost / total fund assets. By law this value is provided to investors for all investment funds. [Expense ratio](https://www.investopedia.com/terms/e/expenseratio.asp) does not include loads or sales commission.
### Equity
- Ownership of a company; stock.
### Fiduciary
- Fiduciaries are legally bound to put their client’s best interests ahead of their own. Clients would hope this is 100% of the time from any financial advisor. However, it can be less than this if a professional is not bound by a code of ethics or because of how they are acting on behalf of their client. A client should always confirm the professional relationship they have with an advisor, including a fiduciary, to confirm that the services offered requires the advisor to act as a fiduciary. See also [Understanding the Investment Advisers Act of 1940: Fiduciary Duty, Registration, and Key Criteria](https://financefacts101.com/understanding-the-investment-advisers-act-of-1940-fiduciary-duty-registration-and-key-criteria/) -> Fiduciary Duty: Loyalty, Care, and Conflicts of Interest.
...
### Instrument
- A financial instrument is a contract or document that represents a financial asset to one party and a financial liability or equity to another party. Financial instruments include various types such as debt (bonds, loans), equity (shares), foreign exchange, and derivatives (options, futures, forwards). 
### Liquidity
...
## Tax Definitions
### Effective Tax Rate
- The average tax rate paid on all income to a taxing authority. The number is unique to each individual and is equal to **total tax / taxable income * 100%**. US investors will find their total tax on line 24 of Form 1040 of their tax return and taxable income on line 15.
### Marginal Tax Rate
...
### Post-tax
- Referring to income or an investment account that has already been taxed. This money can be invested into accounts that offer tax free withdrawal for qualified purposes, i.e. Roth accounts or HSAs, or into taxable brokerage accounts, which are subject to capital gains tax.
...
- A financial investment that gives a tax benefit to an investor. Commonly, this refers to an investment account that allows the investor to decide when their money will be taxed (e.g., IRAs), or is tax free depending on how the money is used (e.g., a health savings account), or is a combination (e.g., again a health savings account).
	- After making the decision to invest for the future, understanding how to protect as much of an investment from being taxed is generally the next most important aspect.
### Tax Cost Ratio
...
- Although somewhat counterintuitive, selling for a loss and repurchasing at the same price (or about the same price) and subsequently investing the resulting tax savings results in more investment income and a greater earnings.
...
## Security
- A financial instrument specifically created to be traded on the secondary market (where securities are traded after their initial offering to the public) with monetary value determined by the supply and demand of the financial market on which it trades. Examples are equities (stocks), debt (bonds), derivatives, etc. 
## Vehicle
- An investment vehicle is a financial instrument or product used by investors to achieve a positive return on their money. Vehicles may include specific types of assets or accounts used by an investor to help them reach their intended monetary goals, hence the term vehicle.
